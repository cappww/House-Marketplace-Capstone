...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        require(!newOwner.isContract(), "The new address cannot be a contract");
        _owner = newOwner;
        emit OwnershipTransfer(_owner);
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "The address cannot be the owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(msg.sender, to), "Either sender is not the owner or is not approved");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) || !to.isContract(), "This token already exists, or address is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "The 'from' address must be the owner of the token");
        // TODO: require token is being transfered to valid address
        require(!to.isContract(), "The 'to' address cannot be a contract");
        // TODO: clear approval
        approve(to, tokenId);
...
contract ERC721Mintable is ERC721Metadata {
    constructor() ERC721Metadata("House", "H", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public { }
